            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="file_path" class="form-control @error('file_path') is-invalid @enderror" value="{{ old('file_path', $resource->file_path) }}" required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="downloads_count" class="form-control @error('downloads_count') is-invalid @enderror" value="{{ old('downloads_count', $resource->downloads_count) }}" min="0">
                    </div>
                </div>
            </div>
            <div class="card mt-3">
